...
(function(){
	...
	.factory("artigoUtil", artigoUtil);

	function artigoUtil($mdDialogstService, $q, $mdDialog, $mdMedia, stCrudToolsUtils){
...
(function(){
	...
	.factory("requestUtil", requestUtil);

	function requestUtil($mdDialogstService, $q, $mdDialog, $mdMedia, stCrudToolsUtils){
...
(function(){
	...
	function democomponentListCtrl($scope, $controller, config, stCrudTools, stUtil, $route){
		...
		angular.extend(ctrl, $controller('genericListController', {
			...
			filtros:  [ 
				{attr:'_string.nome', label: 'Buscar pelo nome do componente'},
...
"use strict";
(function(){
angular.module("stapiApp").controller("changePasswordController",function($rootScope, $scope,stService,$cookieStore,$location,st,$localStorage, stUtil, configUtil){
