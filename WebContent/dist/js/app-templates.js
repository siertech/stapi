angular.module('stapi').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/cliente/html/clienteDetalhe.html',
    "<meta charset=\"UTF-8\"><st-detalhe save-function=\"$clienteDetalheCtrl.data.saveFunction($clienteDetalheCtrl.data.item)\" hide-crud-buttons=\"true\" delete-function=\"$clienteDetalheCtrl.data.deleteFunction($clienteDetalheCtrl.data.item)\" item=\"$clienteDetalheCtrl.data.item\" cancel-function=\"$clienteDetalheCtrl.data.cancelFunction()\" loading=\"$clienteDetalheCtrl.data.loading\" title=\"{{$clienteDetalheCtrl.data.item.principalAttr || 'Cadastro de novo Item'}}\"><cliente-form></cliente-form></st-detalhe>"
  );
  ...
  $templateCache.put('app/inicio/html/inicio.html',
    "<meta charset=\"UTF-8\"><st-check-list attr-label=\"principalAttr\" hide-delete-all=\"true\" show-border-no-items=\"true\" hide-add=\"true\" hide-checkbox=\"true\" crud-options=\"{objectName: 'Cliente'}\"></st-check-list>"
  );
